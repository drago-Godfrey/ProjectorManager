...
if ($result && $result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <input class="styled-button" type="button" onclick="window.location.href='projectorsForm.php'" value="Register Projector">
    </section>
    ...
    <script>
        ...
        function editRecord(recordId) {
            window.location.href = 'editpro.php?id=' + recordId;
        }

        // Function to handle delete action
        function deleteRecord(recordId) {
            if (confirm('Are you sure you want to delete this record?')) {
                window.location.href = 'deletepro.php?id=' + recordId;
            }
        }
    </script>
</body>
