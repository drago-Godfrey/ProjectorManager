...
$result = $conn->query("SELECT * FROM borrowed_projectors");
}
...
<input class="styled-button" type="button" onclick="window.location.href='borrowFormsuper.php'" value="Borrow Projector">
