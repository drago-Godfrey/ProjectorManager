...
<body>
    ...
    <form action="projectorsuper.php" method="post" enctype="multipart/form-data">
		...
		<input class="styled-button" type="button" onclick="window.location.href='projectorviewsuper.php'" value="View Projectors">
    </form>
