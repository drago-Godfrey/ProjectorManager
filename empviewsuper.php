...
<input class="styled-button" type="button" onclick="window.location.href='empFormsuper.php'" value="Register Employees"> 
...
<script>
        ...
        function editRecord(recordId) {
            window.location.href = 'editempsuper.php?id=' + recordId;
        }

        // Function to handle delete action
        function deleteRecord(recordId) {
            if (confirm('Are you sure you want to delete this record?')) {
                window.location.href = 'deleteempsuper.php?id=' + recordId;
            }
        }
    </script>
</body>
