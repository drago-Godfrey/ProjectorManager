...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $result = $conn->query("SELECT * FROM admins WHERE id = $recordId");
...
<head>
    ...
    <title>Edit Admin | Projector Manager</title>
...
<header>
    ...
    <form action="updateadmin.php" method="post">
		...
		<input type="text" name="employee_id" value="<?php echo $row['adminID']; ?>">
		
		<label for="employee_id">Phone Number:</label>
		...
		<input class="styled-button" type="button" onclick="window.location.href='viewadmin.php" value="Cancel">
