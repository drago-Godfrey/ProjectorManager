...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $result = $conn->query("SELECT * FROM projector WHERE id = $recordId");
...
<head>
    ...
    <title>Edit Projector | Projector Manager</title>
...
<header>
    ...
    <form action="updateprosuper.php" method="post">
        <label for="model">Model:</label>
		<input type="text" name="Model" value="<?php echo $row['Model']; ?>">
        
		<label for="condition">Condition:</label>
		<input type="text" name="Conditions" value="<?php echo $row['Conditions']; ?>">
		
		<label for="serial_number">Serial Number:</label>
		<input type="text" name="SerialNumber" value="<?php echo $row['SerialNumber']; ?>">
		...
		<input class="styled-button" type="button" onclick="window.location.href='projectorviewsuper.php" value="Cancel">
